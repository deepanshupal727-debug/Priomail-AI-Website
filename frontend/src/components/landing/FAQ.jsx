...
const FAQS = [
  {
    ...
    a: "Every incoming message is sent (encrypted, in-transit) to our priority AI engine with a tuned classification schema. We assign one of five labels — CRITICAL, URGENT, NORMAL, SPAM, PHISHING — based on sender, content, your past responses, and contextual signals. Classification happens in real time, the moment the email lands in your inbox.",
  },
  {
